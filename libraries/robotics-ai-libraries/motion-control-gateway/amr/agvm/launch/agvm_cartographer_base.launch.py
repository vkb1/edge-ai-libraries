...
def generate_launch_description():
    ...
    agvm_cartographer_prefix = get_package_share_directory('agvm')
    cartographer_config_dir = LaunchConfiguration('cartographer_config_dir', 
                                                    default=os.path.join(agvm_cartographer_prefix, 'config'))
    configuration_basename = LaunchConfiguration('configuration_basename', default='cartographer_config.lua')

    resolution = LaunchConfiguration('resolution', default='0.0125')
