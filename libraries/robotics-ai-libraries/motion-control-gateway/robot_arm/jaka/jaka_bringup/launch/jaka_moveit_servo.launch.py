...
def generate_launch_description():
    ...
    jaka_tracking_pid_yaml = load_yaml("jaka_servo", "config/jaka_tracking_pid.yaml")
    jaka_tracking_pid = {"moveit_servo": jaka_tracking_pid_yaml}

    jaka_tracking_config_yaml = load_yaml("jaka_servo", "config/jaka_tracking_config.yaml")
    jaka_tracking_config = {"moveit_servo": jaka_tracking_config_yaml}
