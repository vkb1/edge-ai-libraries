...
def generate_launch_description():
    ...
    controllers_yaml = load_yaml('run_jaka_moveit', 'config/moveit_controllers.yaml')
    ...
    return LaunchDescription([ robot_state_publisher, static_tf, rviz_node, run_jaka_moveit_node])
