...
def generate_launch_description():
    ...
    moveit_cpp_yaml_file_name = os.path.join(
        get_package_share_directory('rrbot_moveit_demo'),
        'config',
        'moveit_cpp.yaml')
    ...
    controllers_yaml = load_yaml('rrbot_moveit_demo',
    ...
    "robot_description_planning": load_yaml(
        "rrbot_moveit_demo", "config/joint_limits.yaml"
    )
    }

    # MoveItCpp demo executable
    run_moveit_cpp_node = Node(name='run_moveit_cpp',
                               package='rrbot_moveit_demo',
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("rrbot_bringup"),
        "config",
