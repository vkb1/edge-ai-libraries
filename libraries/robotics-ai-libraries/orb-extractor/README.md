...
For detailed usage instructions and pre-requisites, refer to the [ORB Extractor Overview](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/robotics/dev_guide/tutorials_amr/perception/orb-extractor/package-use.html).

## Documentation

Comprehensive documentation on this component is available here:

- [ORB Extractor Index](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/robotics/dev_guide/tutorials_amr/perception/orb-extractor/index.html)
- [API Usage](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/robotics/dev_guide/tutorials_amr/perception/orb-extractor/api-use.html)
- [OpenCV-free Usage](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/robotics/dev_guide/tutorials_amr/perception/orb-extractor/orbocvfree-use.html)
- [Limitations](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/robotics/dev_guide/tutorials_amr/perception/orb-extractor/limitation.html)
