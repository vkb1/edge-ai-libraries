...
For detailed usage instructions and pre-requisites, refer to [the documentation](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-suites/robotics-ai-suite/components/optimized_solutions/orb-extractor.html).
