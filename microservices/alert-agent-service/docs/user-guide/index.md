...
<div class="component_card_widget">
  <a class="icon_github" href="https://github.com/open-edge-platform/edge-ai-libraries/tree/release-2026.2.0/microservices/alert-agent-service">
     GitHub
  </a>
  <a class="icon_github" href="https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2026.2.0/microservices/alert-agent-service/README.md">
     Readme
  </a>
</div>
hide_directive-->
