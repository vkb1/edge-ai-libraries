...
- In order to configure the camera for hardware triggering, during our tests we set the following properties of Generic Plugin.
  ...
  - `hw-trigger-timeout=100` - the H/W trigger timeout value in seconds in multiples of 5
    ...
    For more information on the properties related to hardware triggering refer to [Generic-Plugin-readme](https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2026.2.0/microservices/dlstreamer-pipeline-server/plugins/camera/src-gst-gencamsrc/README.md)
