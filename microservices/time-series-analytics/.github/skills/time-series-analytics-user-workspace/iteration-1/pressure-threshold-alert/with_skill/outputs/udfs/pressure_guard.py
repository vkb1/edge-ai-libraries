...
# Safe hydraulic pressure operating band (bar). Anything outside this range
# is flagged.
LOW, HIGH = 80.0, 150.0


class PressureGuardHandler(Handler):
    """Flags hydraulic pressure_bar readings outside the safe [LOW, HIGH] band."""
...
if __name__ == '__main__':
    agent = Agent()
    agent.handler = PressureGuardHandler(agent)
