...
integration context, see the [Video Search and Summarization release notes](https://docs.openedgeplatform.intel.com/2026.2/edge-ai-libraries/video-search-and-summarization/release-notes.html).
