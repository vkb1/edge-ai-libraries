...
- [Retriever backend source notes](https://github.com/open-edge-platform/edge-ai-libraries/blob/release-2026.2.0/microservices/vector-retriever/vector-retriever/src/retriever/backends/README.md)
